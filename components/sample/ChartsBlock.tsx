						...
						>
							...
							>
								...
								<ChartTooltip
									...
									cursor={false}
								/>
								<ReferenceLine y={1200} stroke={colorScale['400']} strokeDasharray='3 3' strokeWidth={1}>
									<Label position='insideBottomLeft' value='Average Steps' offset={10} fill={colorScale['700']} />
									<Label
				...
				<Card className='flex flex-col lg:max-w-md' x-chunk='charts-01-chunk-1'>
					...
					<CardContent className='flex flex-1 items-center'>
						...
						>
							...
							>
								<CartesianGrid strokeDasharray='4 4' vertical={false} stroke={colorScale['300']} strokeOpacity={0.5} />
					...
					<CardContent className='grid gap-4'>
						<div className='grid auto-rows-min gap-2'>
							...
							>
								...
								>
									<Bar dataKey='steps' fill={chartColors.chart3} radius={4} barSize={32}>
										<LabelList
											position='insideLeft'
											dataKey='date'
											offset={8}
											fontSize={12}
											fill={getContrastColor(chartColors.chart3)}
										/>
									</Bar>
						...
						<div className='grid auto-rows-min gap-2'>
							...
							>
								...
								>
									<Bar dataKey='steps' fill={colorScale['300']} radius={4} barSize={32}>
										<LabelList
											position='insideLeft'
											dataKey='date'
											offset={8}
											fontSize={12}
											fill={getContrastColor(colorScale['300'])}
										/>
									</Bar>
									<YAxis dataKey='date' type='category' tickCount={1} hide />
									<XAxis dataKey='steps' type='number' hide />
