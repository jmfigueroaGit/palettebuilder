				...
				<ColorTooltip colors={{ Primary: baseColor, Overlay: chroma(baseColor).alpha(0.8).css() }}>
					<div className='relative rounded-lg overflow-hidden shadow-lg aspect-[4/3]'>
						<Image
							...
							objectFit='cover'
							placeholder='blur'
							blurDataURL='/placeholder-1-blur.jpg'
				...
				>
					<div className='relative rounded-lg overflow-hidden shadow-lg aspect-[4/3]'>
						<Image
							...
							objectFit='cover'
							placeholder='blur'
							blurDataURL='/placeholder-2-blur.jpg'
							sizes='(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw'
						/>
						<div
						...
						>
							<div className='text-center'>
								<h3 className='text-xl sm:text-2xl font-bold text-white'>Design</h3>
								<p className='text-base sm:text-lg text-white'>Beautiful color palettes</p>
							</div>
						</div>
					</div>
				</ColorTooltip>
				...
				>
					<div className='relative rounded-lg overflow-hidden shadow-lg aspect-[4/3]'>
						<Image
							...
							objectFit='cover'
							placeholder='blur'
							blurDataURL='/placeholder-3-blur.jpg'
							sizes='(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw'
						/>
						<div
						...
						>
							<div>
								<h3 className='text-lg sm:text-xl font-bold text-white'>Implement</h3>
								<p className='text-base sm:text-lg text-white'>Seamless color integration</p>
							</div>
						</div>
					</div>
				</ColorTooltip>
